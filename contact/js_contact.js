<!-- 
var url = "contact/db_contact.php"; // เปลี่ยนที่จะให้ไปที่ไฟล์ db_xxx.php
...
function add_reply(name,mail,message){ // นำข้อมูลมาใส่ไว้ในฟอร์มเพื่อให้ผู้ดูและระบบสามารถตอบกลับได้ (เมื่อคลิกที่ปุ่มตอบกลับ)

	document.f_comment.name.value = name;
	document.f_comment.mail.value = mail;
	document.f_comment.comment.value = "คำถามอ้างอิงจาก : คุณ "+name+"\n\n"+message+"\n \n ---------------------------------------- \n \n ข้อความตอบกลับ : \n\n";
...
/*	else if(document.f_comment.mail.value ==""){
